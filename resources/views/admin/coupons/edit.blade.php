    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.coupons.update", [$coupon->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('price') ? 'is-invalid' : '' }}" type="number" name="price" id="price" value="{{ old('price', $coupon->price) }}" step="1000" required>
                @if($errors->has('price'))
                    <div class="invalid-feedback">
                        {{ $errors->first('price') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <textarea  class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" rows="15"  id="description"  cols="40"  value="{{ old('description', $coupon->description)}}" required></textarea>
                <!-- <input class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" type="number" name="price" id="price" value="{{ old('price', $coupon->price) }}" step="0.01" required> -->
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('expired_date') ? 'is-invalid' : '' }}" type="date" name="expired_date" id="expired_date" value="{{ old('expired_date', $coupon->expired_date) }}" required>
