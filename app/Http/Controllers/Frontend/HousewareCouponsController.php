...
class HousewareCouponsController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.housewarecoupons.index', compact('purchases'));
    }
    ...
    public function show($purchase)
    {
        ...
        return view('frontend.housewarecoupons.show', ['purchase' => $item]);
    }
}
